...
g++.exe src\Ambiente.cpp src\Organismo.cpp src\Populacao.cpp src\Simulador.cpp main.cpp -o PixelGameLife.exe -std=c++17 -O2 -IC:\raylib\raylib\src -LC:\raylib\raylib\src -lraylib -lopengl32 -lgdi32 -lwinmm -static
if %ERRORLEVEL% neq 0 (
